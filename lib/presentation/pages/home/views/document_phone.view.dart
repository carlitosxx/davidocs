          ...
          slivers: [
            ...
            documentTypeState.maybeWhen(
              ...
              data: (responseListDocumentsEntity) {
                ...
                // ? SliverList.builder(
                //     itemCount: responseListDocumentsEntity.datos
                //         .where(
                //           (document) => document.detalledocumento
                //               .toLowerCase()
                //               .contains(
                //                 search.text.toLowerCase(),
                //               ),
                ...
                //         .length,
                //     itemBuilder: (context, index) {
                //       final filtered = responseListDocumentsEntity.datos
                //           .where(
                //             (document) => document.detalledocumento
                //                 .toLowerCase()
                //                 .contains(
                ...
                //                 .read(documentDetailProvider.notifier)
                //                 .getDocumentDetailUC(
                //                     filtered[index].codigodocumento);
                //             ref
                //                 .read(appRouterProvider)
                //                 .pushNamed('document_detail');
                //           },
                ...
                //                   children: [
                //                     Text(
                //                         ' ${kDownloads.i18n} ${filtered[index].totaldescargas}'),
                //                     Text(filtered[index].historicoEnt)
                //                   ],
                //                 )
                //               ],
                //             ),
